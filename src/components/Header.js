      ...
      <div className="container mx-auto text-center">
        ...
        <nav className="mt-4">
          <ul className="flex justify-center space-x-6">
            ...
            <li>
              <Link href="/gallery" className="text-white hover:text-yellow-200 transition-colors">
                Photos
              </Link>
            </li>
            <li>
              <Link href="/videos" className="text-white hover:text-yellow-200 transition-colors">
                Videos
              </Link>
            </li>
          </ul>
